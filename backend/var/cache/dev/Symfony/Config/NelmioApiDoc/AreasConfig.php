...
class AreasConfig 
{
     ...
     * @deprecated Since nelmio/api-doc-bundle 4.36.0: The "with_annotation" option is deprecated. Use "with_attribute" instead.
     * @return $this
     */
    ...
    public function __construct(array $config = [])
    {
        ...
        if (array_key_exists('with_annotation', $config)) {
            $this->_usedProperties['withAnnotation'] = true;
            $this->withAnnotation = $config['with_annotation'];
            unset($config['with_annotation']);
        }
